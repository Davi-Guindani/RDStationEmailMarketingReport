        ...
        graphic_list = [
            Graphic(
                ...
                [
                    ...
                    campaign["contacts_count"] - campaign["email_dropped_count"],
                ],
                ["contatos", "enviados"],
                [0, int(tick / 4), int(tick * 2 / 4), int(tick * 3 / 4), tick],
                "Métricas",
            ...
            Graphic(
                ...
                [
                    round(campaign["email_delivered_rate"], 1),
                    round(campaign["email_opened_rate"], 1),
                    round(campaign["email_clicked_rate"], 1),
                    round(campaign["email_spam_reported_rate"], 1),
                    round(
                        campaign["email_unsubscribed_count"]
                        / campaign["email_delivered_count"],
                        1,
                    ),
                ],
                [
        ...
        for graphic in graphic_list:
            ...
            with open(fname, "rb") as content_file:
                ...
                email.add_attachment(
                    content, maintype="application", subtype="png", filename=fname
                )
